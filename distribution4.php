...
$dateL = date("Y-m-d H:i:s");
    ...
    $updateStockQueryL = $conn->prepare("INSERT INTO aradhiyin (dateL, metheka, nb, total) VALUES (?, ?, ?, ?)");
...
$updateStockQueryL = $conn->prepare("INSERT INTO tethkirl (dateL, nomL, matriculeL, quentiteL,adresse) VALUES (?, ?, ?, ?,'A')");
$updateStockQueryL->bind_param("ssss", $dateL, $nomL, $matriculeL, $quentiteL);
$updateStockQueryL->execute();

if ($updateStockQueryL->affected_rows > 0) {
    echo "<div style='margin-top: 20px; text-align: center;'>";
    echo "<p style='color: green; font-size: 38px; font-weight: bold;'>تم توزيع مذاقة العرضيون بنجاح</p>";
